...
<section id="corpo-body">
  <div id="welcome">
    ...
    <p class ="iText">
      ...
      <b>O nosso conversor é extramente simples e rápido de utilizar!</b>
    </p>
  </div>
  ...
  <div id="rules">
    <ol>
      ...
      <li>Clique no botão de <b>Download</b> para iniciar a conversão.</li>
      <li>Assim ele irá fazer todo o processo de <b>conversão</b>!</li>
      <li>E pronto! Arquivo convertido com sucesso.</li>
    </ol>
    <b>Simples e prático!</b>
  </div>
...
<div id='divUrl'>
    <form id='downloadForm' enctype='multipart/form-data' method='POST'>
      ...
      <br><br><br>
      <button id="btDownload" type="submit" name="download">
      <img src="../static/Images/botaoDownload.png" width="50" height="50">
      </button>
    </form>
  </div>
    <br><br><br><br><br><br>
...
<!-- Script PHP -->
  <?php
  //Analisando se ouve o clique no botão 'download'
  if(isset($_POST['download'])){
    //Validação se há arquivo dentro do input de arquivos
    if($_FILES['video']['name'] == ""){
      //Balão de aviso sobre não haver arquivos dentro do input
      echo '<script type="text/javascript">
      window.onload = function () { window.location.href; alert("Por favor, você precisa inserir um arquivo para converter!"); } 
      </script>';
      echo '<script type="text/javascript">
      window.location.href="../index.php";
      ';
    }else{
      //Se houver arquivos no input então envia o arquivo para a pasta 'Donwload' em 'Convertia/Screen/Download'
      move_uploaded_file($_FILES['video']['tmp_name'], 'Download/'.$_FILES['video']['name']);

      //Chama o método de converter em 'Convertia/PHP/conversor.php' como parâmetro o nome do arquivo que o usuário subiu no input de files.
      echo $conver->converterMp3($_FILES['video']['name']);
    }
  }
  ?>
  <!-- Fim do script PHP -->
